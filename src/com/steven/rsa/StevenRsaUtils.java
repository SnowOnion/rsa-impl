...
/**
 *http://www.cnblogs.com/stevenczp/p/4299072.html
 * @author steven
 */
public class StevenRsaUtils {
	...
	public static BigInteger getPrime2(int bitCount) {
		BigInteger init =BigInteger.probablePrime(bitCount,ran);
		//基于素数定理, 平均只需要不到n次搜索, 就能找到一个素数
		while (!isPrime(init)) {
			init = init.add(BigInteger.valueOf(2));
		}
